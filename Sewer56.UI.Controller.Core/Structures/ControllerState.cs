...
public struct ControllerState
{
    ...
    public void Update(in FrameInputs inputs)
    {
    ...
    public Vector2 GetDirectionVector(bool flipX, bool flipY) => PressedButtons.GetDirectionVector(flipX, flipY);
    ...
    /// </summary>
    public bool Equals(in ControllerState other) => HeldButtons == other.HeldButtons && PressedButtons == other.PressedButtons && ReleasedButtons == other.ReleasedButtons;

    /// <inheritdoc />
    public override bool Equals(object obj) => obj is ControllerState other && Equals(other);

    /// <inheritdoc />
    public override int GetHashCode() => HashCode.Combine((int)HeldButtons, (int)PressedButtons, (int)ReleasedButtons);
    #endregion
}